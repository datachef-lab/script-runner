...
# DEFAULT_INPUT_FILE = "input.xlsx"  # Will be overridden by command line args
# DEFAULT_OUTPUT_FILE = "exam_results.xlsx"  # Will be overridden by command line args
# DEFAULT_LOG_FILE = "scraping_log.xlsx"  # Will be overridden by command line args
